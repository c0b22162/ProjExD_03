...
class Bird:
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        """
        img0 = pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex03/fig/{num}.png"), 0, 2.0)
    ...
    def change_img(self, num: int, screen: pg.Surface):
        ...
        """
        self.img = pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex03/fig/{num}.png"), 0, 2.0)
...
class Beam:
    ...
    def __init__(self, bird: Bird):
        ...
        引数 bird：ビームを放つこうかとん
        """
        self.img = pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex03/fig/beam.png"), 0, 2.0)
        self.rct = self.img.get_rect()
